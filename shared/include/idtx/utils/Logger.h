 ...
 */
constexpr auto IDTX_ERROR = idtx::utils::LogLevel::Error;
constexpr auto IDTX_WARN  = idtx::utils::LogLevel::Warn;
constexpr auto IDTX_INFO  = idtx::utils::LogLevel::Info;
constexpr auto IDTX_DEBUG = idtx::utils::LogLevel::Debug;
 ...
 *   IDTX_LOG(IDTX_ERROR, "Failed for '{}': {}", url, err);
 */
#define IDTX_LOG(level, ...) idtx::utils::Log::log(level, LOG_CATEGORY, __VA_ARGS__)
 ...
 */
#define IDTX_LOGF(level, ...) idtx::utils::Log::log(level, std::string_view{"General"}, __VA_ARGS__)